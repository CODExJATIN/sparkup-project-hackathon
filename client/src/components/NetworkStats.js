    ...
    <>
      <div className="flex flex-row auto-cols-max border border-[#3F4346] divide-x divide-[#3F4346] rounded-md bg-black opacity-80 h-9 ">
        ...
        {error === "no-error-loading" &&
          <div className="group inline-flex items-center gap-3 text-xs text-white ml-3 ">
        ...
        {error === "no-error" &&
          <>
            <div className="group  inline-flex items-center gap-2 text-xs text-white basis-1/2 w-32">
              <DownloadIcon />
              {downloadSpeed} MBPS
            </div>
            <div className="group inline-flex items-center gap-2 text-xs text-white basis-1/2 w-32">
